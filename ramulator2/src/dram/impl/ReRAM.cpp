...
class ReRAM : public IDRAM, public Implementation {
  ...
  public:
    ...
    inline static const std::map<std::string, std::vector<int>> timing_presets = {
      ...
      /* nRFC   */ 240,  // ReRAMNoRefresh 下不会实际使用，保留非负占位值以通过 timing 校验
      /* nRFCSB */ 240,
      /* nREFI  */ 4680,
      /* nREFISB*/ 4680,
      /* nRREFD */ 10,
  ...
  {"ReRAM_Leader_5.2Gbps", {
      5200,
      2,
      20, 24, 24, 19, 45, 63, 34, 6, 8, 6, 2, 4, 6, 6, 2, 4, 8, 11, 3, 39, 260, 260, 5070, 5070, 11, 769
  }},
  {"ReRAM_Leader_5.6Gbps", {
      5600,
      2,
      21, 26, 26, 20, 48, 68, 37, 6, 9, 6, 2, 4, 6, 7, 2, 4, 9, 12, 3, 42, 280, 280, 5460, 5460, 12, 714
  }},
  {"ReRAM_Leader_6.0Gbps", {
      6000,
      2,
      23, 27, 27, 21, 51, 72, 39, 6, 9, 6, 2, 4, 6, 7, 2, 4, 9, 12, 3, 45, 300, 300, 5850, 5850, 12, 667
  }},
  {"ReRAM_Leader_6.4Gbps", {
      6400,
      2,
      24, 29, 29, 23, 55, 77, 42, 7,10, 7, 2, 4, 7, 8, 2, 4,10, 13, 3, 48, 320, 320, 6240, 6240, 13, 625
  }},
    };
